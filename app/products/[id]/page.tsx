...
// ✅ Directly type the function parameters
...
// ✅ Same here — no custom Props type
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4">
            {product?.description?.split("\n").map((line, index) => (
              <p key={index} className="text-sm text-black">{line}</p>
            ))}
          </div>
        </div>
...
// // ✅ Correct metadata generation function
...
//               <PriceInfoCard title="Highest Price" iconSrc="/assets/icons/arrow-up.svg" value={`${product.currency} ${formatNumber(product.originalPrice)}`} />
